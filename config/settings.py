...
SECRET_KEY = 'django-insecure-=la9e1hp28#0tcjf=-b80@^mjsl3rh50%5v$o_g=s7#u+q7-x('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['Karylleaquino.pythonanywhere.com', '127.0.0.1', 'localhost', 'testserver']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'hangarin_app.context_processors.request_processor',
